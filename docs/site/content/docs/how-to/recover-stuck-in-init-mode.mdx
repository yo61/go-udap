...
<HowTo
  ...
  steps={[
    ...
    <>Re-run the <a href="/go-udap/tutorials/configure-your-first-squeezebox">tutorial</a> from a clean state.</>,
    <>If the device DOESN'T appear in <code>discover</code> after factory reset, see <a href="/go-udap/how-to/no-devices-found">Troubleshoot &quot;no devices found&quot;</a>.</>,
  ]}
  verification={
